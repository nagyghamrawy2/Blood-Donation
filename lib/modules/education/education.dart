      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
               CircleAvatar(
                backgroundImage: NetworkImage("${cubit.educationItemData[index].image}"),
                radius: 60,
              ),
              SizedBox(
                     ...
                     InkWell(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => EducationArticlesScreen(description: cubit.educationItemData[index].description!, image: cubit.educationItemData[index].image!, title: cubit.educationItemData[index].title! ,)));
                          },
                    ),
                  ],
                ),
