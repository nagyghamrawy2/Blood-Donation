  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppStates>(listener: (context, state) {
      if (state is AppSuccessCityEditRequestDataState) {
        idIndexOfCityEditRequest = AppCubit.get(context)
            .cityEditRequestItemList
            .indexWhere((element) =>
                element.cityName ==
                myRequestModel!.requests![indexOfMyRequest!].city!.cityName);
            ...
            children: [
              ConditionalBuilder(
                ...
                fallback: (context) => Center(
                  child:
                      Text('No Requests Yet !', style: TextStyle(fontSize: 30)),
                ),
              ),
              ConditionalBuilder(
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      cubit.getCityEditRequestData(
                                          id: (myRequestModel!.requests![index]
                                              .governorate!.id)!);
